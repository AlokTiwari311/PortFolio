...
import blueLogo from '../../assets/images/graylogo.png';
  ...
  return (
    ...
    >
      ...
      <a href="#hero" aria-label="Logo" className="z-50">
        <img
          ref={logo}
          src={blueLogo} // Adjust this path if needed
          alt="Alok Tiwari Logo"
          width="80"  // Adjust width as necessary
          height="45" // Adjust height as necessary
        />
      </a>
      ...
      <nav className=" space-x-7 font-grotesk text-body-3 sm:block">
        ...
        <a href="#main-gc" className="group relative hidden md:inline-block">
          <span>services</span>
          <span className="absolute bottom-0 left-0 h-[0.125em] w-0 rounded-full bg-secondary-600 duration-300 ease-in-out group-hover:w-full"></span>
        </a>
