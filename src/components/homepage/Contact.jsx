      ...
      <div ref={contactSection} className="mt-10 flex flex-col gap-20 md:grid md:grid-cols-6 md:px-12">
        <div className="col-span-4">
          ...
          <p ref={body} className="mt-4 max-w-md 2xl:max-w-2xl text-body-2 2xl:text-4xl text-accent-100 translate-y-10 opacity-0">
            I am currently available for freelance work and open to exciting new opportunities! Starting from June 2024, I will be accepting new projects. Whether you're looking for help with web development, backend systems, or any tech-related projects, feel free to reach out.
          </p>
          <form
            name="contact"
            action="/contact"
        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          <div className="space-y-3 ">
            ...
            <div className="flex flex-col space-y-3 text-body-2 2xl:text-3xl">
              <a
                ...
                rel="noreferrer"
              >
                <span>aloktiwari311113@gamil.com</span>
          ...
          <div className="space-y-3 ">
            ...
            <div className="space-y-3 text-body-2 2xl:text-3xl">
              ...
              <a
                href="https://github.com/AlokTiwari311"
              ...
              <a
                href="https://www.instagram.com/aloktiwari311/"
                className="group flex items-center space-x-2"
                target="_blank"
                rel="noreferrer"
              >
